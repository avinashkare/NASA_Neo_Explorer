...
export const AsteroidVisual: React.FC<AsteroidVisualProps> = ({
  ...
  return (
    <>
      ...
      {/* Asteroid */}
      <div
        className={`absolute cursor-pointer transition-all duration-500 ease-out transform ${
      ...
      >
        ...
        <div 
          className={`absolute inset-0 rounded-full transition-all duration-500 ${
            isHazardous ? 'bg-red-500' : 'bg-cyan-400'
        ...
        {isHazardous && (
          <div 
            className={`absolute inset-0 rounded-full bg-red-500 blur-sm transition-all duration-500 ${
              isHovered ? 'opacity-60 animate-pulse' : 'opacity-30'
            }`}
            style={{
